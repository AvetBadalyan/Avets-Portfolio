...
const learningItems = [
  {
    ...
    emoji: "☁️",
    title: "AWS Cloud",
    description: "Studying for AWS Solutions Architect certification",
    status: "In Progress",
  },
  {
    id: 2,
    emoji: "🧪",
    title: "Testing",
    description: "Jest, React Testing Library, and E2E with Playwright",
    status: "Practicing",
  },
  {
    id: 3,
    emoji: "📖",
    title: "System Design",
    description: "Scalability patterns, caching, and distributed systems",
    status: "Reading",
  },
];
